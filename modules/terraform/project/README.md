...
<h3 align="center">Terraform Project</h3>
  <p align="center">
    This module creates a terraform cloud project.
    <br />
...
> **Terraform-only**: This module uses the `hashicorp/tfe` provider to manage Terraform Cloud/Enterprise projects. It requires Terraform and is **not compatible with OpenTofu**.
