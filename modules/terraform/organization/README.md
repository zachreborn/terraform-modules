...
> **Terraform-only**: This module uses the `hashicorp/tfe` provider to manage Terraform Cloud/Enterprise organizations. It requires Terraform and is **not compatible with OpenTofu**.
