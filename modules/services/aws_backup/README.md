...
| <a name="input_cross_account_backup_enabled"></a> [cross_account_backup_enabled](#input_cross_account_backup_enabled)                               | (Optional) Specifies whether cross-account backup is enabled. This is used in AWS organizations in order to centrally manage AWS Backups in either the organization management account or a delegated admin backups account. Defaults to true.                                                                                                                                                        | `bool`     | `true`                                                                                                                                                                                       |    no    |
...
| <a name="input_tags"></a> [tags](#input_tags)                                                                                                       | (Optional) A mapping of tags to assign to the object.                                                                                                                                                                                                                                                                                                                                                 | `map(any)` | <pre>{<br/> "aws_backup": "true",<br/> "created_by": "<YOUR_NAME>",<br/> "environment": "prod",<br/> "priority": "critical",<br/> "service": "backups",<br/> "terraform": "true"<br/>}</pre> |    no    |
