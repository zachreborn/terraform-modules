...
- Profiles and overrides expose every `github_repository` argument in provider 6.11.0. Deprecated arguments remain available only to preserve existing settings during import; do not select them for new repositories.
