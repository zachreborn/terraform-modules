...
run "enable_flow_logs_true_creates_flow_logs_module" {
  ...
  # group ID), which is independent of flow_transit_gateway_attachment_ids --
  # so this doesn't fully prove wiring beyond "the module didn't error".
  # Stronger wiring outputs are added in the separate fix PR #409 (out of
  # scope for this test-only PR since they require editing
