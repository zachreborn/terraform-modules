...
variable "name" {
  type        = string
  description = "(Required) The name of the policy. If omitted, Terraform will assign a random, unique name. Changes to the name will force the creation of a new resource."
}
