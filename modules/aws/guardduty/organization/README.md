...
| <a name="input_auto_enable_auto_enable_organization_members"></a> [auto\_enable\_auto\_enable\_organization\_members](#input\_auto\_enable\_auto\_enable\_organization\_members) | (Optional) Indicates the auto-enablement configuration of GuardDuty for the member accounts in the organization. Valid values are ALL, NEW, NONE. Defaults to ALL. | `string` | `"ALL"` | no |
