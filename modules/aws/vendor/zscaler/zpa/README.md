...
| <a name="input_instance_type"></a> [instance\_type](#input\_instance\_type) | (Optional) EC2 instance type for ZPA App Connector instances. Defaults to m5a.xlarge per Zscaler's official module recommendation. | `string` | `"m5.large"` | no |
