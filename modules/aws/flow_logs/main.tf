...
resource "aws_flow_log" "vpc_flow" {
  ...
  eni_id                        = var.flow_eni_ids ? each.value : null
  ...
  subnet_id                     = var.flow_subnet_ids ? each.value : null
  tags                          = var.tags
  transit_gateway_id            = var.flow_transit_gateway_ids ? each.value : null
  transit_gateway_attachment_id = var.flow_transit_gateway_attachment_ids ? each.value : null
  traffic_type                  = var.flow_traffic_type
  vpc_id                        = var.flow_vpc_ids ? each.value : null
}
