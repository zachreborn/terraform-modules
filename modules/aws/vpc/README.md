...
| <a name="input_flow_eni_ids"></a> [flow\_eni\_ids](#input\_flow\_eni\_ids) | (Optional) List of Elastic Network Interface IDs to attach the flow logs to, in addition to this module's own VPC. Passed through to modules/aws/flow\_logs. | `list(string)` | `null` | no |
...
| <a name="input_flow_subnet_ids"></a> [flow\_subnet\_ids](#input\_flow\_subnet\_ids) | (Optional) List of Subnet IDs to attach the flow logs to, in addition to this module's own VPC. Passed through to modules/aws/flow\_logs. | `list(string)` | `null` | no |
...
| <a name="input_flow_transit_gateway_attachment_ids"></a> [flow\_transit\_gateway\_attachment\_ids](#input\_flow\_transit\_gateway\_attachment\_ids) | (Optional) List of IDs of the transit gateway attachments to attach the flow logs to. Passed through to modules/aws/flow\_logs. | `list(string)` | `null` | no |
| <a name="input_flow_transit_gateway_ids"></a> [flow\_transit\_gateway\_ids](#input\_flow\_transit\_gateway\_ids) | (Optional) List of IDs of the transit gateways to attach the flow logs to. Passed through to modules/aws/flow\_logs. | `list(string)` | `null` | no |
