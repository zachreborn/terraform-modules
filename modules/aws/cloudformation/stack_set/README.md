...
| <a name="input_permission_model"></a> [permission_model](#input_permission_model)                                                 | The permissions model to use to create the stack set. Valid values are: SERVICE_MANAGED, SELF_MANAGED                                                                                                                                         | `string`       | `"SELF_MANAGED"` |    no    |
