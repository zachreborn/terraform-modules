...
| <a name="input_type"></a> [type](#input_type)                                        | (Optional) - The directory type (SimpleAD, ADConnector or MicrosoftAD are accepted values). Defaults to SimpleAD. | `string`       | `"ADConnector"`   |    no    |
