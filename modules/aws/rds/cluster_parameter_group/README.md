...
<h3 align="center">RDS Cluster Parameter Group</h3>
  <p align="center">
    This module configures a RDS cluster parameter group for use in a cluster and with cluster instances.
    <br />
...
module "webapp_aurora_cluster_parameter_group_5_7" {
  source = "github.com/zachreborn/terraform-modules//modules/aws/rds/cluster_parameter_group"
...
| Name                                                                                                                                             | Type     |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | -------- |
| [aws_rds_cluster_parameter_group.group](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/rds_cluster_parameter_group) | resource |
