    ...
    "Statement" = [
      {
        ...
        "Condition" = {
          ...
          "StringLike" = {
            "${var.terraform_cloud_hostname}:sub" : "organization:${var.terraform_organization}:project:${var.terraform_cloud_project_name}:workspace:${var.terraform_workspace_name}:run_phase:*"
          }
        }
      }
    ]
